      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center gap-1.5">
            ...
            <InfoTooltip>
              Shown on a device notification when a release/rollback/rollout change reaches it while the app is
              fully closed (requires Firebase to be configured — see docs/GETTING_STARTED.md). Leave blank to use
              the built-in default (&quot;App update available&quot;).
            </InfoTooltip>
          </div>
          <Input
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            placeholder="A new version is ready."
            value={pushBody}
